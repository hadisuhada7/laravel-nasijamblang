...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Bilingual copy for the Visitor Form page (/visitor-form).
    |--------------------------------------------------------------------------
    */
    'visitor_form' => [
        'id' => [
            ...
            'subtitle'         => 'Isi data berikut untuk mencatat kunjungan Anda ke Gastronomi Nasi Jamblang — warisan kuliner pesisir Cirebon.',
            ...
            'privacy'          => 'Data Anda disimpan di server dan tidak dibagikan kepada pihak lain.',
            ...
            'successFlash'     => 'Terima kasih! Kunjungan Anda telah tercatat.',
        ],
        'en' => [
            'overline'         => 'Visitor Form',
            'title'            => 'Register Your Visit',
            'subtitle'         => 'Fill in the details below to record your visit to The Gastronomy of Nasi Jamblang — culinary heritage of coastal Cirebon.',
            'labelName'        => 'Full Name',
            ...
            'privacy'          => 'Your data is stored on our server and not shared with any third party.',
            ...
            'successFlash'     => 'Thank you! Your visit has been recorded.',
        ],
    ],

    /*
    |--------------------------------------------------------------------------
    | Bilingual copy for the Visitor Data page (/visitor-data).
    |--------------------------------------------------------------------------
    */
    'visitor_data' => [
        'id' => [
